 ...
 <div class="box">
	...
	?>
      ...
      <div class = "login">
         <?php	    		 
	 if (isset($_SESSION['userId'])){
	      echo '<form action="../homepageprofile.php" method="get">
    ...
    <div class="search-bar">
      <form action="searchAnime.php" method="get">
        <input type="text" placeholder="Search For anime..." name="search" id="movie" autocomplete="off">
...
<div class="wrapper">
            ...
            <nav id="sidebar">
			    ...
			    &nbsp;&nbsp;
                     ...
                     <li>
                        <a href="../YoutubeVideos/youtubeVideoHome.php" >
			    &nbsp;&nbsp;
...
<?php
     require 'autocompleteAnimeSearch.php';
 ?>
