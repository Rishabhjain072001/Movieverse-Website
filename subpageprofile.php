	...
	if (mysqli_num_rows($result) > 0){
		while($row = mysqli_fetch_assoc($result)){
			...
			while($rowImg = mysqli_fetch_assoc($resultImg)){
				echo "<a href='subpage.php?movie_title=".$movie_title."&movie_id=".$movie_id."&release_date=".$release_date."&movie_lang=".$movie_lang."&tmdb_id=".$tmdb_id."'><svg class='arrow-left' width='2em' height='2em' viewBox='0 0 16 16' class='bi bi-chevron-double-left' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
				...
				echo "<div class='profile'><center>";
				   if ($rowImg['status'] == 0){
					...
					echo "<form action='includes/subpagedeleteprofile.php' method='POST'>
